# Functional Python [![](https://github.com/finnless/functional-python/workflows/tests/badge.svg)](https://github.com/finnless/functional-python/actions?query=workflow%3Atests)
